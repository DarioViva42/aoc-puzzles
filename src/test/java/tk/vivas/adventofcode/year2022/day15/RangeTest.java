...
class RangeTest {
    ...
    void toTouchType_containing() {
        ...
        assertThat(rangeOne.toTouchType(rangeTwo)).isEqualTo(TouchType.CONTAINS);
        assertThat(rangeTwo.toTouchType(rangeOne)).isEqualTo(TouchType.CONTAINED);
    }
    ...
    void toTouchType_touching() {
        ...
        assertThat(rangeOne.toTouchType(rangeTwo)).isEqualTo(TouchType.LEFT);
        assertThat(rangeTwo.toTouchType(rangeOne)).isEqualTo(TouchType.RIGHT);
    }
    ...
    void toTouchType_disjoint() {
        ...
        assertThat(rangeOne.toTouchType(rangeTwo)).isEqualTo(TouchType.NOT_TOUCHING);
        assertThat(rangeTwo.toTouchType(rangeOne)).isEqualTo(TouchType.NOT_TOUCHING);
    }
